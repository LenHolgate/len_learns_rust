...
pub struct Intervals {
    intervals: BTreeSet<Interval<u8>>,
}
...
impl Intervals {
    ...
    pub fn remove_first_interval(&mut self) -> Interval<u8> {
    ...
    fn find(&self, interval: &Interval<u8>) -> Option<Interval<u8>> {
    ...
    fn insert(&mut self, interval: Interval<u8>) -> bool {
    ...
    fn insert_or_join_intervals(& mut self, interval: Interval<u8>, next: Interval<u8>, prev: Interval<u8>) {
    ...
    fn insert_or_merge_with_next(& mut self, interval: Interval<u8>, next: Interval<u8>) {
    ...
    fn insert_or_merge_with_prev(& mut self, interval: Interval<u8>, prev: Interval<u8>) {
